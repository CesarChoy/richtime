	...
	<div id="gy_guide_safety_xzk">
		...
		<div class="px1000" id="gy_guide_announcement">
			<div class="clearfix gy_guide_announcement_bigbox">
						...
						<ul class="gy_member_submenu_content">
							<li class="gy_member_current" id="gy_member_current_gywm">
								...
								<ul class="df_member_submenu_ul" style="display:block;">
									...
									<li><span>&nbsp;</span><a href="javascript:;" class="gsgg gsqbtx">公司公告</a></li>
				...
				<!--公司公告-->
				<div class="fl gy_guide_announcement_rigth" id="gsgg" style="display:block;">
					<p class="gy_guide_announcement_r_header">公司公告</p>
					<div class="gy_guide_announcement_r_listtable ">
						<div>
							<span style="font-size:12px;" class="fr">2015年07月24日</span>
							<span><span class="aaaaa fl">&nbsp;</span>关于“推荐新用户，红包大派送”活动公告</span>
						</div>
   					</div>
   					<div class="gy_guide_announcement_r_listtable">
						<div>
