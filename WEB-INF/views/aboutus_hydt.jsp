	...
	<div id="gy_guide_safety_xzk">
		...
		<div class="px1000" id="gy_guide_announcement">
			<div class="clearfix gy_guide_announcement_bigbox">
					...
					<nav>
						...
						<ul class="gy_member_submenu_content">
							...
							<li class="gy_member_current" id="gy_member_current_hydt">
								<div class="gy_member_current_bg_bottom">
									<span class="gy_member_current_bg"></span>
									<span class="gy_member_current_bg_border" style="color:#29A7E1">行业动态</span>
								</div>
				...
				<!--split line-->
				<!--行业动态-->
				<div class="fl gy_guide_announcement_rigth" id="hydt" style="display:block;">
					<p class="gy_guide_announcement_r_header">行业动态</p>
					<div class="gy_guide_announcement_r_listtable">
						<div>
							<span style="font-size:12px;" class="fr">2015年07月24日</span>
							<span><span class="aaaaa fl">&nbsp;</span>大众富裕阶层青睐互联网金融 e租宝成...</span>
						</div>
   					</div>
   					<div class="gy_guide_announcement_r_listtable">
						<div>
					...
					<div class="gy_guide_index_xzkbid_paging" style="margin-bottom:5px;">
						共8页
